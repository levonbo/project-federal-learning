...
def objective(trial):
    ...
    for data_flag in mnist_datasets:
        ...
        train_loader, train_loader_at_eval, _ = dataset.get_loader(data_flag, config.param.model_name, BATCH_SIZE, config.param.download, config.param.size)    
        ...
        for epoch in range(1):
            ...
            Com_avg_loss.append(validation.validate_model(model, train_loader_at_eval, task, criterion)) 
    return statistics.mean(Com_avg_loss)
