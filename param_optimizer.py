...
def objective(trial):
    ...
    mnist_datasets = ["retinamnist", "chestmnist","dermamnist", "octmnist", "pneumoniamnist", "pathmnist", "breastmnist", "bloodmnist", "tissuemnist","organamnist", "organcmnist","organsmnist"]
    dataset_scores = []
    for data_flag in mnist_datasets:
        ...
        dataset_scores.append(score) #type: ignore
